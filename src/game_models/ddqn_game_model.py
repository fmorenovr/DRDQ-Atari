...
class DDQNGameModel(BaseGameModel):
  def __init__(self, game_name, mode_name, input_shape, action_space, logger_path, model_path, cnn_mode):
    ...
    self.ddqn = ConvolutionalNeuralNetwork(self.input_shape, action_space, cnn_mode).model
...
class DDQNSolver(DDQNGameModel):
  def __init__(self, game_name, input_shape, action_space, getDate, cnn_mode):
    testing_model_path = "./output/neural_nets/" + game_name + "/ddqn/model/" + getDate + "/model.h5"
    ...
    DDQNGameModel.__init__(self,
                           ...
                           input_shape,
                           action_space,
                           "./output/logs/" + game_name + "/ddqn/testing/" + getDate + "/",
                           testing_model_path,
                           cnn_mode)
...
class DDQNTrainer(DDQNGameModel):
  def __init__(self, game_name, input_shape, action_space, getDate, cnn_mode):
    DDQNGameModel.__init__(self,
                           ...
                           input_shape,
                           action_space,
                           "./output/logs/" + game_name + "/ddqn/training/" + getDate + "/",
                           "./output/neural_nets/" + game_name + "/ddqn/model/" + getDate + "/model.h5",
                           cnn_mode)
    ...
    self.ddqn_target = ConvolutionalNeuralNetwork(self.input_shape, action_space, cnn_mode).model
